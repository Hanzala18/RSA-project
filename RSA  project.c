...
int main()
{
    ...
    printf("***************************************************\n");
    printf("***\t\t\t\t\t\t***\n");
    printf("***\tWELCOME!'RSA ENCRPTION & DECRIPTION' \t***\n" );
    printf("***\t\t\t\t\t\t***\n");
    printf("***************************************************\n");
...
A:
        printf("\n\n");
        printf("Do you want to decrypt an pre-exeisting file or manullay enter mesange :\n 1 for yes or 2 for manuall data enterence  ");
        scanf("%d",&choice);
        printf("\n\n");
